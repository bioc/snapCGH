...
double fr_three(int n, double *par, void *ex){
  ...
  for(t = 1; t < nrow1; t++){
    gammaC[0][0] = gammaA[0][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[0][0]);
    gammaC[0][1] = gammaA[0][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[0][1]);
    gammaC[0][2] = gammaA[0][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[0][2]);
    gammaC[1][0] = gammaA[1][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][0]);
    gammaC[1][1] = gammaA[1][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][1]);
    gammaC[1][2] = gammaA[1][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][2]);
    gammaC[2][0] = gammaA[2][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][0]);
    gammaC[2][1] = gammaA[2][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][1]);
    gammaC[2][2] = gammaA[2][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][2]);
...
double fr_four(int n, double *par, void *ex){
  ...
  for(t = 1; t < nrow1; t++){
    ...
    gammaC[0][1] = gammaA[0][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[0][1]);
    gammaC[0][2] = gammaA[0][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[0][2]);
    gammaC[0][3] = gammaA[0][3] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[0][3]);
    gammaC[1][0] = gammaA[1][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][0]);
    gammaC[1][1] = gammaA[1][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][1]);
    gammaC[1][2] = gammaA[1][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][2]);
    gammaC[1][3] = gammaA[1][3] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][3]);
    gammaC[2][0] = gammaA[2][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][0]);
    gammaC[2][1] = gammaA[2][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][1]);
    gammaC[2][2] = gammaA[2][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][2]);
    gammaC[2][3] = gammaA[2][3] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][3]);
    gammaC[3][0] = gammaA[3][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[3][0]);
    gammaC[3][1] = gammaA[3][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[3][1]);
    gammaC[3][2] = gammaA[3][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[3][2]);
    gammaC[3][3] = gammaA[3][3] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[3][3]);
...
double fr_five(int n, double *par, void *ex){
  ...
  for(t = 1; t < nrow1; t++){
    ...
    gammaC[0][2] = gammaA[0][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[0][2]);
    gammaC[0][3] = gammaA[0][3] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[0][3]);
    gammaC[0][4] = gammaA[0][4] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[0][4]);
    gammaC[1][0] = gammaA[1][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][0]);
    gammaC[1][1] = gammaA[1][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][1]);
    gammaC[1][2] = gammaA[1][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][2]);
    gammaC[1][3] = gammaA[1][3] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][3]);
    gammaC[1][4] = gammaA[1][4] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[1][4]);
    gammaC[2][0] = gammaA[2][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][0]);
    gammaC[2][1] = gammaA[2][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][1]);
    gammaC[2][2] = gammaA[2][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][2]);
    gammaC[2][3] = gammaA[2][3] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][3]);
    gammaC[2][4] = gammaA[2][4] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[2][4]);
    gammaC[3][0] = gammaA[3][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[3][0]);
    gammaC[3][1] = gammaA[3][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[3][1]);
    gammaC[3][2] = gammaA[3][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[3][2]);
    gammaC[3][3] = gammaA[3][3] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[3][3]);
    gammaC[3][4] = gammaA[3][4] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[3][4]);
    gammaC[4][0] = gammaA[4][0] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[4][0]);
    gammaC[4][1] = gammaA[4][1] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[4][1]);
    gammaC[4][2] = gammaA[4][2] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[4][2]);
    gammaC[4][3] = gammaA[4][3] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[4][3]);
    gammaC[4][4] = gammaA[4][4] + ((exp(-(pow(covars[t-1],rate1))))*gammaB[4][4]);
