...
void two_states_praxis(int *nrow, double *xin, double *data, double *covars, int *varfixed, double *result){
...
void three_states_praxis(int *nrow, double *xin, double *data, double *covars, int *varfixed, double *result){
...
void four_states_praxis(int *nrow, double *xin, double *data, double *covars, int *varfixed, double *result){
...
void five_states_praxis(int *nrow, double *xin, double *data, double *covars, int *varfixed, double *result){
